...
<html>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">PESS - DEVELOPER</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Paul Suarez Socasaca</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Desarrollo Sistemas  - Desarrollo Web  - Desarrollo Aplicaciones </p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">SOBRE MI PERSONA</h2>
                <!-- Icon Divider-->
                <div class="divider-custom divider-light">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Soy una persona Responsable y de facil Comunicacion, me Gusta Ayudar en lo posible simpre trato de enseñar mis Conocimientos, Me gustan hacer la presentaciones con fechas exactas</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">En cuanto a los proyectos siempre inicio con un maquetacion simple pasandolo a una funcionalidad basica, luego trabajo conjuntamente con el Cliente para Que el Proyecto Quede Como Quieras <b>
                        Tambien Realizo modificaciones en sistemas sean WEB, Aplicativos moviles, o Sistemas Completos
                    </p></div>
                </div>
                <!-- About Section Button-->
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="https://drive.google.com/file/d/1qecJEOP1jMpUJVG5lqQRkpMG3CQkGZw3/view?usp=sharing" target="_blank">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            Levante Proyectos de Tiendas Virtuales con <a href="https://pe.wordpress.org/" target="_blank">Wordpress</a>  <b>
                                Y Sistemas de puntos de venta con 
